...
<?php 
    ...
    <ul class="pagination justify-content-center">
      ...
      ?>
        <li class="page-item"><a class="page-link" href="halamanuser.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
      <?php
        }
      ?>
      ...
      ?>
        <li <?php echo $linkActive; ?>><a class="page-link" href="halamanuser.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
      <?php
        }
      ?>
      ...
      ?>
        <li class="page-item"><a class="page-link" href="halamanuser.php?page=<?php echo $linkNext; ?>">Next</a></li>
      <?php
      }
      ?>
